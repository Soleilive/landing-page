  ...
  return (
    <main className="bg-[#0D1821] toppad min-h-screen w-screen text-white">
      ...
      <div className="fit-content content">
        ...
        <p>SoveiLive is a social media platform where users have data ownership. The application will be completely decentralized and accessible to as many people as possible: it will be possible to use the application gas-free.</p>
